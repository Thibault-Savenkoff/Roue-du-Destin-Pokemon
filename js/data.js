...
const defaultData = {
    ...
    statsValues: [
        { label: "10",  percentage: 0.5,  value: 10  },
        { label: "20",  percentage: 1,    value: 20  },
        { label: "25",  percentage: 2,    value: 25  },
        { label: "30",  percentage: 3,    value: 30  },
        { label: "35",  percentage: 4,    value: 35  },
        { label: "40",  percentage: 5,    value: 40  },
        { label: "45",  percentage: 6,    value: 45  },
        { label: "50",  percentage: 7,    value: 50  },
        { label: "55",  percentage: 8,    value: 55  },
        { label: "60",  percentage: 10,   value: 60  },
        { label: "65",  percentage: 12,   value: 65  },
        { label: "70",  percentage: 14,   value: 70  },
        { label: "75",  percentage: 11,   value: 75  },
        { label: "80",  percentage: 8,    value: 80  },
        { label: "85",  percentage: 6,    value: 85  },
        { label: "90",  percentage: 4,    value: 90  },
        { label: "95",  percentage: 2.5,  value: 95  },
        { label: "100", percentage: 1.5,  value: 100 },
        { label: "110", percentage: 1,    value: 110 },
        { label: "125", percentage: 0.7,  value: 125 },
        { label: "150", percentage: 0.2,  value: 150 },
        { label: "160", percentage: 0.1,  value: 160 },
